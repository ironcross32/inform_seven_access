...
class InformTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.scriptHandler = SimpleNamespace(
            script=script,
            getLastScriptRepeatCount=Mock(return_value=0),
        )
        self.getObject = Mock()
    ...
    def test_status_is_fresh_and_independent_of_dynamic_reporting(self) -> None:
    ...
    def test_status_repeat_spells_and_copies(self) -> None:
    ...
    def test_missing_status_is_reported_without_reading_ide_status(self) -> None:
